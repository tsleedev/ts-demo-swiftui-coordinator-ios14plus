...
public struct CView<Coordinator: CoordinatorProtocol>: View {
    ...
    public var body: some View {
        VStack {
            ...
            Text("CView \(item.title)")
        }
        .toolbar {
            ToolbarItem(placement: .navigationBarTrailing) {
                Button {
                    coordinator.push(.aView(.init(title: "From CView")))
                } label: {
            ...
            ToolbarItem(placement: .navigationBarTrailing) {
                Button {
                    coordinator.push(.bView(.init(title: "From CView")))
                } label: {
            ...
            ToolbarItem(placement: .navigationBarTrailing) {
                Button {
                    coordinator.push(.cView(.init(title: "From CView")))
                } label: {
